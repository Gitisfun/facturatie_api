...
function QUERY_GET_ALL(sort_field, sort_order){
    ...
    return QUERY + QUERY_JOIN_LEV + QUERY_JOIN_KLANT + QUERY_JOIN_GEBRUIKER + JOIN_LEV + JOIN_KLANT + JOIN_GEBRUIKERS + WHERE + QueryString.all(fields, COLUMN_DATUM, "DESC")
}
...
function QUERY_CREATE() {
    const COLUMNS = [COLUMN_BESTELLING_NR, COLUMN_DATUM, COLUMN_KLANT_ID, COLUMN_REF_NR, COLUMN_BTW_ID, COLUMN_VERVALDAG, COLUMN_LEVERDATUM, COLUMN_LEVERANCIER_ID, COLUMN_INCOTERM, COLUMN_VALUTA, COLUMN_BEGIN_TEKST, COLUMN_EIND_TEKST, COLUMN_FACTUURADRES, COLUMN_LEVERADRES, COLUMN_SUBTOTAAL, COLUMN_TOTAAL, COLUMN_OPMERKING, COLUMN_UPDATED_BY, COLUMN_BEDRIJF_ID]
    return BaseQueries.create(TABLE_NAME, COLUMNS)
}

function QUERY_UPDATE() {
    const COLUMNS = [COLUMN_BESTELLING_NR, COLUMN_DATUM, COLUMN_KLANT_ID, COLUMN_REF_NR, COLUMN_BTW_ID, COLUMN_VERVALDAG, COLUMN_LEVERDATUM, COLUMN_LEVERANCIER_ID, COLUMN_INCOTERM, COLUMN_VALUTA, COLUMN_BEGIN_TEKST, COLUMN_EIND_TEKST, COLUMN_FACTUURADRES, COLUMN_LEVERADRES, COLUMN_SUBTOTAAL, COLUMN_TOTAAL, COLUMN_IS_GELEVERD, COLUMN_IS_BETAALD, COLUMN_UPDATED_BY, COLUMN_OPMERKING]
