...
const COLUMN_ID = "id"
const COLUMN_FACTUUR_ID = "factuur_nr"
const COLUMN_DATUM = "datum"
const COLUMN_KLANT_ID = "klant_id"
const COLUMN_LEVERINGS_NR = "leverings_nr"
const COLUMN_BESTEL_NR = "bestel_nr"
...
const COLUMN_KLANT_ID = "id"
const COLUMN_KLANT_NAAM = "naam"

const ALIAS_KLANT_ID = "klant_id"
const ALIAS_KLANT_NAAM = "klant_naam"
...
function QUERY_GET_ALL(sort_field, sort_order){
    const fields = ["datum", "bestel_nr", "leverings_nr"]
    
    const QUERY = `SELECT ${TABLE_NAME}.${COLUMN_ID}, ${TABLE_NAME}.${COLUMN_FACTUUR_ID}, ${TABLE_NAME}.${COLUMN_DATUM}, ${TABLE_NAME}.${COLUMN_LEVERINGS_NR}, ${TABLE_NAME}.${COLUMN_BESTEL_NR}, ${TABLE_NAME}.${COLUMN_LEVERDATUM}, ${TABLE_NAME}.${COLUMN_TOTAAL}, ${TABLE_NAME}.${COLUMN_IS_GELEVERD}, ${TABLE_NAME}.${COLUMN_IS_BETAALD}, ${TABLE_NAME}.${COLUMN_IS_ACTIVE}, ${TABLE_NAME}.${COLUMN_UPDATED_TIME}, ${TABLE_NAME}.${COLUMN_UPDATED_BY}, `
    ...
    const QUERY_JOIN_KLANT = `${TABLE_JOIN_KLANT}.${COLUMN_KLANT_ID} "${ALIAS_KLANT_ID}", ${TABLE_JOIN_KLANT}.${COLUMN_KLANT_NAAM} "${ALIAS_KLANT_NAAM}", `
    ...
    const JOIN_KLANT = `LEFT JOIN ${TABLE_JOIN_KLANT} ON ${TABLE_NAME}.${COLUMN_KLANT_ID} = ${TABLE_JOIN_KLANT}.${COLUMN_KLANT_ID} `;
...
function QUERY_GET() {
    const QUERY = `SELECT ${TABLE_NAME}.${COLUMN_ID}, ${TABLE_NAME}.${COLUMN_FACTUUR_ID}, ${TABLE_NAME}.${COLUMN_DATUM}, ${TABLE_NAME}.${COLUMN_LEVERINGS_NR}, ${TABLE_NAME}.${COLUMN_BESTEL_NR}, ${TABLE_NAME}.${COLUMN_VERVALDAG}, ${TABLE_NAME}.${COLUMN_LEVERDATUM}, ${TABLE_NAME}.${COLUMN_INCOTERM}, ${TABLE_NAME}.${COLUMN_VALUTA}, ${TABLE_NAME}.${COLUMN_BEGIN_TEKST}, ${TABLE_NAME}.${COLUMN_EIND_TEKST}, ${TABLE_NAME}.${COLUMN_FACTUURADRES}, ${TABLE_NAME}.${COLUMN_LEVERADRES}, ${TABLE_NAME}.${COLUMN_SUBTOTAAL}, ${TABLE_NAME}.${COLUMN_TOTAAL}, ${TABLE_NAME}.${COLUMN_IS_GELEVERD}, ${TABLE_NAME}.${COLUMN_IS_BETAALD}, ${TABLE_NAME}.${COLUMN_IS_ACTIVE}, ${TABLE_NAME}.${COLUMN_UPDATED_TIME}, ${TABLE_NAME}.${COLUMN_UPDATED_BY}, `
    const QUERY_JOIN_LEV = `${TABLE_JOIN_LEVERANCIER}.${COLUMN_LEV_ID} "${ALIAS_LEV_ID}", ${TABLE_JOIN_LEVERANCIER}.${COLUMN_LEV_NAAM} "${ALIAS_LEV_NAAM}", `
    const QUERY_JOIN_KLANT = `${TABLE_JOIN_KLANT}.${COLUMN_KLANT_ID} "${ALIAS_KLANT_ID}", ${TABLE_JOIN_KLANT}.${COLUMN_KLANT_NAAM} "${ALIAS_KLANT_NAAM}", `
    const QUERY_JOIN_BTW = `${TABLE_JOIN_GEBRUIKER}.${COLUMN_BTW_BTW_ID} "${ALIAS_BTW_ID}", ${TABLE_JOIN_BTW}.${COLUMN_BTW_NAAM} "${ALIAS_BTW_NAAM}", ${TABLE_JOIN_BTW}.${COLUMN_BTW_PRIJS} "${ALIAS_BTW_PRIJS}", `
    const QUERY_JOIN_GEBRUIKER = `${TABLE_JOIN_GEBRUIKER}.${COLUMN_GEBR_ID} "${ALIAS_GEBR_ID}", ${TABLE_JOIN_GEBRUIKER}.${COLUMN_GEBR_VOORNAAM} "${ALIAS_GEBR_VOORNAAM}", ${TABLE_JOIN_GEBRUIKER}.${COLUMN_GEBR_ACHTERNAAM} "${ALIAS_GEBR_ACHTERNAAM}" FROM ${TABLE_NAME} `
    const JOIN_LEV = `LEFT JOIN ${TABLE_JOIN_LEVERANCIER} ON ${TABLE_NAME}.${COLUMN_LEVERANCIER_ID} = ${TABLE_JOIN_LEVERANCIER}.${COLUMN_LEV_ID} `;
    const JOIN_KLANT = `LEFT JOIN ${TABLE_JOIN_KLANT} ON ${TABLE_NAME}.${COLUMN_KLANT_ID} = ${TABLE_JOIN_KLANT}.${COLUMN_KLANT_ID} `;
...
function QUERY_CREATE() {
    const COLUMNS = [COLUMN_FACTUUR_ID, COLUMN_DATUM, COLUMN_KLANT_ID, COLUMN_LEVERINGS_NR, COLUMN_BESTEL_NR, COLUMN_BTW_ID, COLUMN_VERVALDAG, COLUMN_LEVERDATUM, COLUMN_LEVERANCIER_ID, COLUMN_INCOTERM, COLUMN_VALUTA, COLUMN_BEGIN_TEKST, COLUMN_EIND_TEKST, COLUMN_FACTUURADRES, COLUMN_LEVERADRES, COLUMN_SUBTOTAAL, COLUMN_TOTAAL, COLUMN_IS_GELEVERD, COLUMN_IS_BETAALD, COLUMN_IS_ACTIVE, COLUMN_UPDATED_BY, COLUMN_BEDRIJF_ID]
