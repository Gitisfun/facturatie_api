...
const TABLE_NAME = "tekst";

const COLUMN_ID = "id"
const COLUMN_TEKST = "tekst"
...
function QUERY_GET_ALL(){
    const QUERY = `SELECT ${TABLE_NAME}.${COLUMN_ID}, ${TABLE_NAME}.${COLUMN_TEKST}, ${TABLE_NAME}.${COLUMN_TYPE}, ${TABLE_NAME}.${COLUMN_UPDATED_TIME}, `
    ...
    const ORDER = `ORDER BY ${TABLE_NAME}.${COLUMN_TEKST} ASC`;
...
function QUERY_CREATE() {
    const COLUMNS = [COLUMN_TEKST, COLUMN_TYPE, COLUMN_UPDATED_BY, COLUMN_BEDRIJF_ID]
