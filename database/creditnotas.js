...
function QUERY_CREATE() {
    const COLUMNS = [COLUMN_ORDER_NR, COLUMN_DATUM, COLUMN_KLANT_ID, COLUMN_REF_NR, COLUMN_BTW_ID, COLUMN_BETALINGSDATUM, COLUMN_VALUTA, COLUMN_OPMERKING_ORDER, COLUMN_EIND_TEKST, COLUMN_FACTUURADRES, COLUMN_SUBTOTAAL, COLUMN_TOTAAL, COLUMN_ARTIKELS, COLUMN_OPMERKING, COLUMN_UPDATED_BY, COLUMN_BEDRIJF_ID]
    return BaseQueries.create(TABLE_NAME, COLUMNS)
}

function QUERY_UPDATE() {
    const COLUMNS = [COLUMN_ORDER_NR, COLUMN_DATUM, COLUMN_KLANT_ID, COLUMN_REF_NR, COLUMN_BTW_ID, COLUMN_BETALINGSDATUM, COLUMN_VALUTA, COLUMN_OPMERKING_ORDER, COLUMN_EIND_TEKST, COLUMN_FACTUURADRES, COLUMN_SUBTOTAAL, COLUMN_TOTAAL, COLUMN_IS_BETAALD, COLUMN_UPDATED_BY, COLUMN_ARTIKELS, COLUMN_OPMERKING]
